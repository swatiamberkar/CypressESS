...
describe('02_Project Master', function () {
	...
	it('Navigate to Project Master', function() {	
		...
		cy.wait(500)
		cy.get('#TravelApprovalDetail').click({force: true})
		cy.wait(5000)
	})
	

	it('Verify Validation - Please Enter Project Name.', function() {	
	...
	it('Verify Validation - Duplicate Project Name. Please Enter Another Project Name', function() {	
